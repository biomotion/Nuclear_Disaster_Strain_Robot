...
namespace duckietown_msgs
{
  ...
  class CoordinationSignal : public ros::Msg
  {
    public:
      ...
      enum { SIGNAL_PRIORITY =  CAR_SIGNAL_PRIORITY };
      enum { SIGNAL_SACRIFICE_FOR_PRIORITY =  CAR_SIGNAL_SACRIFICE_FOR_PRIORITY };
    ...
    const char * getMD5(){ return "3caa78ed5f7d2e4ac24db630f8ee77a8"; };
