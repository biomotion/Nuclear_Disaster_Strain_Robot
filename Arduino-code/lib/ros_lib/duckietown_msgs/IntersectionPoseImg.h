#ifndef _ROS_duckietown_msgs_IntersectionPoseImg_h
#define _ROS_duckietown_msgs_IntersectionPoseImg_h
...
namespace duckietown_msgs
{
  ...
  class IntersectionPoseImg : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "duckietown_msgs/IntersectionPoseImg"; };
    const char * getMD5(){ return "9be288b28225c76ee9ce1052704524b8"; };
