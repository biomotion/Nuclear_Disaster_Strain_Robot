#ifndef _ROS_duckietown_msgs_Twist2DStampedETHZ17_h
#define _ROS_duckietown_msgs_Twist2DStampedETHZ17_h
...
namespace duckietown_msgs
{
  ...
  class Twist2DStampedETHZ17 : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "duckietown_msgs/Twist2DStampedETHZ17"; };
